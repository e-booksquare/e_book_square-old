                    ...
                    <div>
                        <div class="conectar_google">
                            <a href=""><button type="button" class="botao_google"><img
                                        src="../assets/IMAGENS/google.gif" alt="">Logar com o google</button></a>
                        </div>
                        ...
                        <p style="text-align:center; font-size: 13px;">Você não tem cadastrado? <a
                                href="cadastro.php">Clique aqui</a> </p>
                    </div>
                </div>
            </div>
        </form>
