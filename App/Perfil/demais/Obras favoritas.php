            ...
            <div class="conteudo_perfil">
                ...
                <div class="container-obras">
                    <div class="nav-main">
                        ...
                        <a href="Obras favoritas.php" ><li class="titulo_obras" style="padding-left: 15px;  font-size: 25px;">Obras favoritas</li> </a>

                        <a href="Obras lendo.php" ><li class="titulo_obras" style=" padding-left: 15px;color: rgba(0,0,0,.600); font-size: 25px;">Lendo</li> </a>
                        </ul>
                    </div>
