...
<head>
    ...
    <title>Editar // <?=$dados_usuario['codigo'];?></title>
...
<body>
    ...
    <!-- Alterar banner -->
        <div class="banner_editar"> 
            ...
            <button type="submit" style="cursor: pointer;" name="deleteBanner"><img class="lixeira_banner" src="ESTILO\Imagens\icon_remover.png" alt=""></button>
            ...
            <div class="imagem_perfil_editar"> 
                    ...
                    <button  type="submit" style= "cursor: pointer;" name="deleteImagemPerfil"><img class="lixeira" src="ESTILO\Imagens\icon_remover.png" alt=""></button>
                </div>
        </div>
                            <!-- Alterar banner Fim-->
        ...
        <div class="container_informacoes_usuario">
            ...
            <input class="trocar_nome trocar_informacoes" type="text" name="nome" id="" value="<?=$dados_usuario['nome']?>"> <br>

            <input class="troca_codigo trocar_informacoes" type="text" name="codigo" id="" value="<?=$dados_usuario['codigo']?>"> <br>

            <input class="trocar_email trocar_informacoes" type="email" name="email" id="" value="<?=$dados_usuario['email']?>"> <br>
            ...
            <textarea name="descricao" id="descricao" cols="30" rows="10" maxlength="1000" runat="server" style="resize: none;"><?=$dados_usuario['descricao']?></textarea>
            <div class="limitador">
            ...
            <button  class="salvar" type="submit" style=" cursor: pointer;" name="atualizar" id="submit">Salvar</button>
    ...
    <div class="footer_primera_parte">
       ...
       <div class="footer_quarta_parte">
        ...
        <script src="limitador_desc.js"></script> 
        <script src="preview_image.js"></script>
        <script src="preview_banner.js"></script>
        <script>
