        ...
        <main>
            ...
            <nav class="navegacao">
                <ul>
                    ...
                    <a href="notificacao.php"><li class="opcao selecionado ">Notificações</li></a>
            ...
            <section class="config">
                <div class="container_icon">
                    <a href="bloqueios.php"><img class="icone_not" src="../ESTILO/Imagens/Imagem_bloqueio.svg"></a>
                </div>
                <div class="container_icon1">
                    <a href="conta.php"><img class="icone_not" src="../ESTILO/Imagens/Imagem_conta.svg"></a>
                </div>
                <div class="informacoes">
                    <p class="texto_um">Permitir notificações via e-mail</p>
                    <input type="checkbox" name="mensagens" id="mensagens"><span class="texto_checkbox">Mensagens</span>
                    ...
                    <input type="checkbox" name="atualizar" id="atualizar"><span class="texto_checkbox">Atualizações da plataforma</span>
