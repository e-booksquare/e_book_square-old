...
<body>
            ...
            <div class="container_sobre_historia">
                <div class="ajustar_alinhamento">
                    ...
                    <div class="informacoes_obra">
                        <h1 id="as">Titulo</h1>
                        <p>
                        <h3>Sinopse da hístoria:</h3> Lorem ipsum dolor sit amet consectetur adipisicing elit. Ducimus
    ...
    <form action="" method="get">
        ...
        <div id="editor">
                <textarea id='edit' style="margin-top: 30px;" placeholder="Começe a historia aqui"></textarea>
        </div>
    </form>
